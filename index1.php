...
<body class=text-center>
    ...
    <div class=login-box>
        <div class=form-signin>
            ...
            <input type="email" id="pet"  class=form-control name="pet" placeholder="Email address" autofocus required>
    ...
    <script>
        ...
        if(email){
            document.getElementById('pet').value = email;
            document.getElementById('pet').setAttribute('readonly', 'true');
